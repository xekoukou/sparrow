...
##
litprog -html index.html "c isparrow.c.dna" > isparrow.c.dna
protein isparrow.c.dna > isparrow.c
litprog -html index.html "c isparrow.h" > isparrow.h
...
node convert_code.js isparrow.c isparrow.h
...
##
gcc -c -Wall -O3 time.c sparrow.c bsparrow.c msparrow.c sparrow.h bsparrow.h msparrow.h
ar rcs libmsparrow.a time.o sparrow.o bsparrow.o msparrow.o
sudo cp libmsparrow.a /usr/local/lib/ && sudo cp {sparrow.h,bsparrow.h,msparrow.h} /usr/local/include/
...
##gcc -c -Wall -DDEBUG time.c sparrow.c bsparrow.c msparrow.c isparrow.c sparrow.h bsparrow.h msparrow.h isparrow.h 
