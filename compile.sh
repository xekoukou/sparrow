...
node convert_code.js sparrow.c sparrow.h simple_test_server.c simple_test_client.c thr_client.c thr_server.c timeout_client.c timeout_server.c
...
gcc -Wall -O3 sparrow.c sparrow.h thr_client.c -o thr_client
gcc -Wall -O3 sparrow.c sparrow.h thr_server.c -o thr_server
gcc -g -Wall -DDEBUG_LOG sparrow.c sparrow.h timeout_client.c -o timeout_client
gcc -g -Wall -DDEBUG_LOG sparrow.c sparrow.h timeout_server.c -o timeout_server
