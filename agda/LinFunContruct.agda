...
---- As long as ltr contains a point that does not belong to s.
  shr-tr-thoerem : ∀{i u rll} → ∀ ll → (s : SetLL ll) → (ltr : LLTr {i} {u} rll ll)
        → STrIr s ltr → let fl = fltr ltr in shrink ll s ≡ shrink (proj₁ fl) (tran s (proj₂ fl))
  shr-tr-thoerem (ll ∧ rl) ↓ .(∧c _) (sti∧c (inj₁ x)) = ⊥-elim (x hitsAtLeastOnce↓)
  shr-tr-thoerem (ll ∧ rl) ↓ .(∧c _) (sti∧c (inj₂ y)) = ⊥-elim (y hitsAtLeastOnce↓)
  shr-tr-thoerem (ll ∧ rl) (s ←∧) .(∧c _) (sti∧c x) = refl
  shr-tr-thoerem (ll ∧ rl) (∧→ s) .(∧c _) (sti∧c x) = refl
  shr-tr-thoerem (ll ∧ rl) (↓ ←∧→ s₁) .(∧c _) (sti∧c (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce↓))
  shr-tr-thoerem (.(_ ∧ _) ∧ rl) ((s ←∧) ←∧→ s₁) .(∧c _) (sti∧c (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce←∧↓))
  shr-tr-thoerem (.(_ ∧ _) ∧ rl) ((∧→ s) ←∧→ s₁) .(∧c _) (sti∧c (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce∧→↓))
  shr-tr-thoerem (.(_ ∧ _) ∧ rl) ((s ←∧→ s₁) ←∧→ s₂) .(∧c _) (sti∧c (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce←∧→↓))
  shr-tr-thoerem (.(_ ∨ _) ∧ rl) ((s ←∨) ←∧→ s₁) .(∧c _) (sti∧c (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce←∨↓))
  shr-tr-thoerem (.(_ ∨ _) ∧ rl) ((∨→ s) ←∧→ s₁) .(∧c _) (sti∧c (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce∨→↓))
  shr-tr-thoerem (.(_ ∨ _) ∧ rl) ((s ←∨→ s₁) ←∧→ s₂) .(∧c _) (sti∧c (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce←∨→↓))
  shr-tr-thoerem (.(_ ∂ _) ∧ rl) ((s ←∂) ←∧→ s₁) .(∧c _) (sti∧c (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce←∂↓))
  shr-tr-thoerem (.(_ ∂ _) ∧ rl) ((∂→ s) ←∧→ s₁) .(∧c _) (sti∧c (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce∂→↓))
  shr-tr-thoerem (.(_ ∂ _) ∧ rl) ((s ←∂→ s₁) ←∧→ s₂) .(∧c _) (sti∧c (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce←∂→↓))
  shr-tr-thoerem (ll ∧ rl) (s ←∧→ ↓) .(∧c _) (sti∧c (inj₂ y)) = ⊥-elim (y (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce↓))
  shr-tr-thoerem (ll ∧ .(_ ∧ _)) (s ←∧→ (s1 ←∧)) .(∧c _) (sti∧c (inj₂ y)) = ⊥-elim (y (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce←∧↓))
  shr-tr-thoerem (ll ∧ .(_ ∧ _)) (s ←∧→ (∧→ s1)) .(∧c _) (sti∧c (inj₂ y)) = ⊥-elim (y (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce∧→↓))
  shr-tr-thoerem (ll ∧ .(_ ∧ _)) (s ←∧→ (s1 ←∧→ s2)) .(∧c _) (sti∧c (inj₂ y)) = ⊥-elim (y (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce←∧→↓))
  shr-tr-thoerem (ll ∧ .(_ ∨ _)) (s ←∧→ (s1 ←∨)) .(∧c _) (sti∧c (inj₂ y)) = ⊥-elim (y (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce←∨↓))
  shr-tr-thoerem (ll ∧ .(_ ∨ _)) (s ←∧→ (∨→ s1)) .(∧c _) (sti∧c (inj₂ y)) = ⊥-elim (y (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce∨→↓))
  shr-tr-thoerem (ll ∧ .(_ ∨ _)) (s ←∧→ (s1 ←∨→ s2)) .(∧c _) (sti∧c (inj₂ y)) = ⊥-elim (y (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce←∨→↓))
  shr-tr-thoerem (ll ∧ .(_ ∂ _)) (s ←∧→ (s1 ←∂)) .(∧c _) (sti∧c (inj₂ y)) = ⊥-elim (y (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce←∂↓))
  ...
  shr-tr-thoerem (ll ∂ .(_ ∂ _)) (s ←∂→ (∂→ s1)) .(∂c _) (sti∂c (inj₂ y)) = ⊥-elim (y (hitsAtLeastOnce←∂→∂→ hitsAtLeastOnce∂→↓))
  shr-tr-thoerem (ll ∂ .(_ ∂ _)) (s ←∂→ (s1 ←∂→ s2)) .(∂c _) (sti∂c (inj₂ y)) = ⊥-elim (y (hitsAtLeastOnce←∂→∂→ hitsAtLeastOnce←∂→↓))
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) ↓ .(∧∧d _) (sti∧∧d (inj₁ x)) = ⊥-elim (x hitsAtLeastOnce↓)
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) (↓ ←∧) .(∧∧d _) (sti∧∧d (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧←∧ hitsAtLeastOnce↓))
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) ((s ←∧) ←∧) .(∧∧d _) (sti∧∧d (inj₁ x)) = refl
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) ((∧→ s) ←∧) .(∧∧d _) (sti∧∧d (inj₁ x)) = refl
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) ((s ←∧→ s₁) ←∧) .(∧∧d _) (sti∧∧d (inj₁ x)) = refl
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) (∧→ s) .(∧∧d _) (sti∧∧d (inj₁ x)) = refl
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) (↓ ←∧→ s₁) .(∧∧d _) (sti∧∧d (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce↓)) 
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) ((s ←∧) ←∧→ s₁) .(∧∧d _) (sti∧∧d (inj₁ x)) = refl
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) ((∧→ s) ←∧→ s₁) .(∧∧d _) (sti∧∧d (inj₁ x)) = refl
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) ((↓ ←∧→ s₁) ←∧→ s₂) .(∧∧d _) (sti∧∧d (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce↓)))
  shr-tr-thoerem ((.(_ ∧ _) ∧ lrl) ∧ rl) (((s ←∧) ←∧→ s₁) ←∧→ s₂) .(∧∧d _) (sti∧∧d (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce←∧↓)))
  shr-tr-thoerem ((.(_ ∧ _) ∧ lrl) ∧ rl) (((∧→ s) ←∧→ s₁) ←∧→ s₂) .(∧∧d _) (sti∧∧d (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce∧→↓)))
  shr-tr-thoerem ((.(_ ∧ _) ∧ lrl) ∧ rl) (((s ←∧→ s₁) ←∧→ s₂) ←∧→ s₃) .(∧∧d _) (sti∧∧d (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce←∧→↓)))
  shr-tr-thoerem ((.(_ ∨ _) ∧ lrl) ∧ rl) (((s ←∨) ←∧→ s₁) ←∧→ s₂) .(∧∧d _) (sti∧∧d (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce←∨↓)))
  shr-tr-thoerem ((.(_ ∨ _) ∧ lrl) ∧ rl) (((∨→ s) ←∧→ s₁) ←∧→ s₂) .(∧∧d _) (sti∧∧d (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce∨→↓)))
  shr-tr-thoerem ((.(_ ∨ _) ∧ lrl) ∧ rl) (((s ←∨→ s₁) ←∧→ s₂) ←∧→ s₃) .(∧∧d _) (sti∧∧d (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce←∨→↓)))
  shr-tr-thoerem ((.(_ ∂ _) ∧ lrl) ∧ rl) (((s ←∂) ←∧→ s₁) ←∧→ s₂) .(∧∧d _) (sti∧∧d (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce←∂↓)))
  shr-tr-thoerem ((.(_ ∂ _) ∧ lrl) ∧ rl) (((∂→ s) ←∧→ s₁) ←∧→ s₂) .(∧∧d _) (sti∧∧d (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce∂→↓)))
  shr-tr-thoerem ((.(_ ∂ _) ∧ lrl) ∧ rl) (((s ←∂→ s₁) ←∧→ s₂) ←∧→ s₃) .(∧∧d _) (sti∧∧d (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce←∂→↓)))
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) ↓ .(∧∧d _) (sti∧∧d (inj₂ (inj₁ x))) = ⊥-elim (x hitsAtLeastOnce↓)
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) (↓ ←∧) .(∧∧d _) (sti∧∧d (inj₂ (inj₁ x))) = ⊥-elim (x (hitsAtLeastOnce←∧←∧ hitsAtLeastOnce↓))
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) ((s ←∧) ←∧) .(∧∧d _) (sti∧∧d (inj₂ (inj₁ x))) = refl
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) ((∧→ s) ←∧) .(∧∧d _) (sti∧∧d (inj₂ (inj₁ x))) = refl
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) ((s ←∧→ s₁) ←∧) .(∧∧d _) (sti∧∧d (inj₂ (inj₁ x))) = refl
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) (∧→ s) .(∧∧d _) (sti∧∧d (inj₂ (inj₁ x))) = refl
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) (↓ ←∧→ s₁) .(∧∧d _) (sti∧∧d (inj₂ (inj₁ x))) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce↓))
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) ((s ←∧) ←∧→ s₁) .(∧∧d _) (sti∧∧d (inj₂ (inj₁ x))) = refl
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) ((∧→ s) ←∧→ s₁) .(∧∧d _) (sti∧∧d (inj₂ (inj₁ x))) = refl
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) ((s ←∧→ ↓) ←∧→ s₂) .(∧∧d _) (sti∧∧d (inj₂ (inj₁ x))) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce↓)))
  shr-tr-thoerem ((lll ∧ .(_ ∧ _)) ∧ rl) ((s ←∧→ (s1 ←∧)) ←∧→ s₂) .(∧∧d _) (sti∧∧d (inj₂ (inj₁ x))) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce←∧↓)))
  shr-tr-thoerem ((lll ∧ .(_ ∧ _)) ∧ rl) ((s ←∧→ (∧→ s1)) ←∧→ s₂) .(∧∧d _) (sti∧∧d (inj₂ (inj₁ x))) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce∧→↓)))
  shr-tr-thoerem ((lll ∧ .(_ ∧ _)) ∧ rl) ((s ←∧→ (s1 ←∧→ s2)) ←∧→ s₂) .(∧∧d _) (sti∧∧d (inj₂ (inj₁ x))) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce←∧→↓)))
  shr-tr-thoerem ((lll ∧ .(_ ∨ _)) ∧ rl) ((s ←∧→ (s1 ←∨)) ←∧→ s₂) .(∧∧d _) (sti∧∧d (inj₂ (inj₁ x))) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce←∨↓)))
  shr-tr-thoerem ((lll ∧ .(_ ∨ _)) ∧ rl) ((s ←∧→ (∨→ s1)) ←∧→ s₂) .(∧∧d _) (sti∧∧d (inj₂ (inj₁ x))) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce∨→↓)))
  shr-tr-thoerem ((lll ∧ .(_ ∨ _)) ∧ rl) ((s ←∧→ (s1 ←∨→ s2)) ←∧→ s₂) .(∧∧d _) (sti∧∧d (inj₂ (inj₁ x))) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce←∨→↓)))
  shr-tr-thoerem ((lll ∧ .(_ ∂ _)) ∧ rl) ((s ←∧→ (s1 ←∂)) ←∧→ s₂) .(∧∧d _) (sti∧∧d (inj₂ (inj₁ x))) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce←∂↓)))
  shr-tr-thoerem ((lll ∧ .(_ ∂ _)) ∧ rl) ((s ←∧→ (∂→ s1)) ←∧→ s₂) .(∧∧d _) (sti∧∧d (inj₂ (inj₁ x))) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce∂→↓)))
  shr-tr-thoerem ((lll ∧ .(_ ∂ _)) ∧ rl) ((s ←∧→ (s1 ←∂→ s2)) ←∧→ s₂) .(∧∧d _) (sti∧∧d (inj₂ (inj₁ x))) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce←∂→↓)))
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) ↓ .(∧∧d _) (sti∧∧d (inj₂ (inj₂ y))) = ⊥-elim (y hitsAtLeastOnce↓)
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) (↓ ←∧) .(∧∧d _) (sti∧∧d (inj₂ (inj₂ y))) with shrink lll ↓ | shr-↓-id lll | shrink lrl ↓ | shr-↓-id lrl
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) (↓ ←∧) .(∧∧d _) (sti∧∧d (inj₂ (inj₂ y))) | .lll | refl | .lrl | refl = refl
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) ((s ←∧) ←∧) .(∧∧d _) (sti∧∧d (inj₂ (inj₂ y))) = refl
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) ((∧→ s) ←∧) .(∧∧d _) (sti∧∧d (inj₂ (inj₂ y))) = refl
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) ((s ←∧→ s₁) ←∧) .(∧∧d _) (sti∧∧d (inj₂ (inj₂ y))) = refl
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) (∧→ s) .(∧∧d _) (sti∧∧d (inj₂ (inj₂ y))) = refl
  shr-tr-thoerem ((lll ∧ lrl) ∧ rl) (s ←∧→ ↓) .(∧∧d _) (sti∧∧d (inj₂ (inj₂ y))) = ⊥-elim (y (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce↓))
  shr-tr-thoerem ((lll ∧ lrl) ∧ .(_ ∧ _)) (s ←∧→ (s1 ←∧)) .(∧∧d _) (sti∧∧d (inj₂ (inj₂ y))) = ⊥-elim (y (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce←∧↓))
  shr-tr-thoerem ((lll ∧ lrl) ∧ .(_ ∧ _)) (s ←∧→ (∧→ s1)) .(∧∧d _) (sti∧∧d (inj₂ (inj₂ y))) = ⊥-elim (y (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce∧→↓))
  shr-tr-thoerem ((lll ∧ lrl) ∧ .(_ ∧ _)) (s ←∧→ (s1 ←∧→ s2)) .(∧∧d _) (sti∧∧d (inj₂ (inj₂ y))) = ⊥-elim (y (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce←∧→↓))
  shr-tr-thoerem ((lll ∧ lrl) ∧ .(_ ∨ _)) (s ←∧→ (s1 ←∨)) .(∧∧d _) (sti∧∧d (inj₂ (inj₂ y))) = ⊥-elim (y (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce←∨↓))
  shr-tr-thoerem ((lll ∧ lrl) ∧ .(_ ∨ _)) (s ←∧→ (∨→ s1)) .(∧∧d _) (sti∧∧d (inj₂ (inj₂ y))) = ⊥-elim (y (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce∨→↓))
  shr-tr-thoerem ((lll ∧ lrl) ∧ .(_ ∨ _)) (s ←∧→ (s1 ←∨→ s2)) .(∧∧d _) (sti∧∧d (inj₂ (inj₂ y))) = ⊥-elim (y (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce←∨→↓))
  shr-tr-thoerem ((lll ∧ lrl) ∧ .(_ ∂ _)) (s ←∧→ (s1 ←∂)) .(∧∧d _) (sti∧∧d (inj₂ (inj₂ y))) = ⊥-elim (y (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce←∂↓))
  ...
  shr-tr-thoerem (ll ∧ (rll ∧ rrl)) ↓ .(¬∧∧d _) (sti¬∧∧d (inj₁ x)) = ⊥-elim (x hitsAtLeastOnce↓)
  shr-tr-thoerem (ll ∧ (rll ∧ rrl)) ↓ .(¬∧∧d _) (sti¬∧∧d (inj₂ (inj₁ x))) = ⊥-elim (x hitsAtLeastOnce↓)
  shr-tr-thoerem (ll ∧ (rll ∧ rrl)) ↓ .(¬∧∧d _) (sti¬∧∧d (inj₂ (inj₂ y))) = ⊥-elim (y hitsAtLeastOnce↓)
  shr-tr-thoerem (ll ∧ (rll ∧ rrl)) (s ←∧) .(¬∧∧d _) (sti¬∧∧d x) = refl
  shr-tr-thoerem (ll ∧ (rll ∧ rrl)) (∧→ ↓) .(¬∧∧d _) (sti¬∧∧d x) with shrink rll ↓ | shr-↓-id rll | shrink rrl ↓ | shr-↓-id rrl
  shr-tr-thoerem (ll ∧ (rll ∧ rrl)) (∧→ ↓) .(¬∧∧d _) (sti¬∧∧d x) | .rll | refl | .rrl | refl = refl
  shr-tr-thoerem (ll ∧ (rll ∧ rrl)) (∧→ (s ←∧)) .(¬∧∧d _) (sti¬∧∧d x) = refl
  shr-tr-thoerem (ll ∧ (rll ∧ rrl)) (∧→ (∧→ s)) .(¬∧∧d _) (sti¬∧∧d x) = refl
  shr-tr-thoerem (ll ∧ (rll ∧ rrl)) (∧→ (s ←∧→ s₁)) .(¬∧∧d _) (sti¬∧∧d x) = refl
  shr-tr-thoerem (ll ∧ (rll ∧ rrl)) (↓ ←∧→ s₁) .(¬∧∧d _) (sti¬∧∧d (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce↓)) 
  shr-tr-thoerem (.(_ ∧ _) ∧ (rll ∧ rrl)) ((s ←∧) ←∧→ s₁) .(¬∧∧d _) (sti¬∧∧d (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce←∧↓))
  shr-tr-thoerem (.(_ ∧ _) ∧ (rll ∧ rrl)) ((∧→ s) ←∧→ s₁) .(¬∧∧d _) (sti¬∧∧d (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce∧→↓))
  shr-tr-thoerem (.(_ ∧ _) ∧ (rll ∧ rrl)) ((s ←∧→ s₁) ←∧→ s₂) .(¬∧∧d _) (sti¬∧∧d (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce←∧→↓))
  shr-tr-thoerem (.(_ ∨ _) ∧ (rll ∧ rrl)) ((s ←∨) ←∧→ s₁) .(¬∧∧d _) (sti¬∧∧d (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce←∨↓))
  shr-tr-thoerem (.(_ ∨ _) ∧ (rll ∧ rrl)) ((∨→ s) ←∧→ s₁) .(¬∧∧d _) (sti¬∧∧d (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce∨→↓))
  shr-tr-thoerem (.(_ ∨ _) ∧ (rll ∧ rrl)) ((s ←∨→ s₁) ←∧→ s₂) .(¬∧∧d _) (sti¬∧∧d (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce←∨→↓))
  shr-tr-thoerem (.(_ ∂ _) ∧ (rll ∧ rrl)) ((s ←∂) ←∧→ s₁) .(¬∧∧d _) (sti¬∧∧d (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce←∂↓))
  shr-tr-thoerem (.(_ ∂ _) ∧ (rll ∧ rrl)) ((∂→ s) ←∧→ s₁) .(¬∧∧d _) (sti¬∧∧d (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce∂→↓))
  shr-tr-thoerem (.(_ ∂ _) ∧ (rll ∧ rrl)) ((s ←∂→ s₁) ←∧→ s₂) .(¬∧∧d _) (sti¬∧∧d (inj₁ x)) = ⊥-elim (x (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce←∂→↓))
  shr-tr-thoerem (ll ∧ (rll ∧ rrl)) (s ←∧→ ↓) .(¬∧∧d _) (sti¬∧∧d (inj₂ (inj₁ x))) = ⊥-elim (x (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce↓))
  shr-tr-thoerem (ll ∧ (rll ∧ rrl)) (s ←∧→ (s1 ←∧)) .(¬∧∧d _) (sti¬∧∧d (inj₂ (inj₁ x))) = refl
  shr-tr-thoerem (ll ∧ (rll ∧ rrl)) (s ←∧→ (∧→ s1)) .(¬∧∧d _) (sti¬∧∧d (inj₂ (inj₁ x))) = refl
  shr-tr-thoerem (ll ∧ (rll ∧ rrl)) (s ←∧→ (s1 ←∧→ ↓)) .(¬∧∧d _) (sti¬∧∧d (inj₂ (inj₁ x))) = ⊥-elim (x (hitsAtLeastOnce←∧→∧→ (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce↓)))
  shr-tr-thoerem (ll ∧ (rll ∧ .(_ ∧ _))) (s ←∧→ (s1 ←∧→ (s2 ←∧))) .(¬∧∧d _) (sti¬∧∧d (inj₂ (inj₁ x))) = ⊥-elim (x
                                                                                                       (hitsAtLeastOnce←∧→∧→ (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce←∧↓)))
  shr-tr-thoerem (ll ∧ (rll ∧ .(_ ∧ _))) (s ←∧→ (s1 ←∧→ (∧→ s2))) .(¬∧∧d _) (sti¬∧∧d (inj₂ (inj₁ x))) = ⊥-elim (x
                                                                                                       (hitsAtLeastOnce←∧→∧→ (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce∧→↓)))
  shr-tr-thoerem (ll ∧ (rll ∧ .(_ ∧ _))) (s ←∧→ (s1 ←∧→ (s2 ←∧→ s3))) .(¬∧∧d _) (sti¬∧∧d (inj₂ (inj₁ x))) = ⊥-elim (x
                                                                                                           (hitsAtLeastOnce←∧→∧→ (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce←∧→↓)))
  shr-tr-thoerem (ll ∧ (rll ∧ .(_ ∨ _))) (s ←∧→ (s1 ←∧→ (s2 ←∨))) .(¬∧∧d _) (sti¬∧∧d (inj₂ (inj₁ x))) = ⊥-elim (x
                                                                                                       (hitsAtLeastOnce←∧→∧→ (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce←∨↓)))
  shr-tr-thoerem (ll ∧ (rll ∧ .(_ ∨ _))) (s ←∧→ (s1 ←∧→ (∨→ s2))) .(¬∧∧d _) (sti¬∧∧d (inj₂ (inj₁ x))) = ⊥-elim (x
  ...
  shr-tr-thoerem (ll ∧ (rll ∧ .(_ ∂ _))) (s ←∧→ (s1 ←∧→ (s2 ←∂→ s3))) .(¬∧∧d _) (sti¬∧∧d (inj₂ (inj₁ x))) = ⊥-elim (x
                                                                                                           (hitsAtLeastOnce←∧→∧→ (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce←∂→↓)))
  shr-tr-thoerem (ll ∧ (rll ∧ rrl)) (s ←∧→ ↓) .(¬∧∧d _) (sti¬∧∧d (inj₂ (inj₂ y))) = ⊥-elim (y (hitsAtLeastOnce←∧→∧→ hitsAtLeastOnce↓))
  shr-tr-thoerem (ll ∧ (rll ∧ rrl)) (s ←∧→ (s1 ←∧)) .(¬∧∧d _) (sti¬∧∧d (inj₂ (inj₂ y))) = refl
  shr-tr-thoerem (ll ∧ (rll ∧ rrl)) (s ←∧→ (∧→ s1)) .(¬∧∧d _) (sti¬∧∧d (inj₂ (inj₂ y))) = refl
  shr-tr-thoerem (ll ∧ (rll ∧ rrl)) (s ←∧→ (↓ ←∧→ s2)) .(¬∧∧d _) (sti¬∧∧d (inj₂ (inj₂ y))) = ⊥-elim (y (hitsAtLeastOnce←∧→∧→ (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce↓)))
  shr-tr-thoerem (ll ∧ (.(_ ∧ _) ∧ rrl)) (s ←∧→ ((s1 ←∧) ←∧→ s2)) .(¬∧∧d _) (sti¬∧∧d (inj₂ (inj₂ y))) = ⊥-elim (y
                                                                                                       (hitsAtLeastOnce←∧→∧→ (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce←∧↓)))
  shr-tr-thoerem (ll ∧ (.(_ ∧ _) ∧ rrl)) (s ←∧→ ((∧→ s1) ←∧→ s2)) .(¬∧∧d _) (sti¬∧∧d (inj₂ (inj₂ y))) = ⊥-elim (y
                                                                                                       (hitsAtLeastOnce←∧→∧→ (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce∧→↓)))
  shr-tr-thoerem (ll ∧ (.(_ ∧ _) ∧ rrl)) (s ←∧→ ((s1 ←∧→ s2) ←∧→ s3)) .(¬∧∧d _) (sti¬∧∧d (inj₂ (inj₂ y))) = ⊥-elim (y
                                                                                                           (hitsAtLeastOnce←∧→∧→ (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce←∧→↓)))
  shr-tr-thoerem (ll ∧ (.(_ ∨ _) ∧ rrl)) (s ←∧→ ((s1 ←∨) ←∧→ s2)) .(¬∧∧d _) (sti¬∧∧d (inj₂ (inj₂ y))) = ⊥-elim (y
                                                                                                       (hitsAtLeastOnce←∧→∧→ (hitsAtLeastOnce←∧→←∧ hitsAtLeastOnce←∨↓)))
  shr-tr-thoerem (ll ∧ (.(_ ∨ _) ∧ rrl)) (s ←∧→ ((∨→ s1) ←∧→ s2)) .(¬∧∧d _) (sti¬∧∧d (inj₂ (inj₂ y))) = ⊥-elim (y
